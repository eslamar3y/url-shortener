...
<x-filament::section>
    <div class="space-y-3">
        ...
        <div class="space-y-2 overflow-hidden">
            <div class="overflow-hidden">
                <p class="text-xs text-gray-500 mb-1">الرابط الأصلي:</p>
                <p class="text-sm text-gray-400" style="word-break: break-all; overflow-wrap: anywhere;">
                    {{ $record->original_url }}
                </p>
            </div>
            <div>
                <p class="text-xs text-gray-500 mb-1">الرابط القصير:</p>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 text-center">
        <x-filament::section>
            ...
            <p class="text-sm text-gray-500 mt-1">إجمالي النقرات</p>
        </x-filament::section>
        <x-filament::section>
            <p class="text-3xl font-bold text-success-500">{{ $clicksToday }}</p>
            <p class="text-sm text-gray-500 mt-1">اليوم</p>
        </x-filament::section>
        <x-filament::section>
            <p class="text-3xl font-bold text-info-500">{{ $clicksThisWeek }}</p>
            <p class="text-sm text-gray-500 mt-1">هذا الأسبوع</p>
        </x-filament::section>
        <x-filament::section>
            <p class="text-3xl font-bold text-warning-500">{{ $clicksThisMonth }}</p>
            <p class="text-sm text-gray-500 mt-1">هذا الشهر</p>
        </x-filament::section>
    </div>

    {{-- Chart آخر 7 أيام --}}
    {{-- Chart آخر 7 أيام --}}
<x-filament::section heading="📈 النقرات — آخر 7 أيام">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <x-filament::section heading="📱 الأجهزة">
        ...
        <x-filament::section heading="🌐 المتصفحات">
        ...
        <x-filament::section heading="🌍 الدول">
